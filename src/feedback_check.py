...
def run_feedback_checker(slack_token: str, channel_id: str, thread_ts: str):
...
if __name__ == '__main__':
    ...
    run_feedback_checker(SLACK_BOT_TOKEN, CHANNEL_ID, THREAD_TS)
