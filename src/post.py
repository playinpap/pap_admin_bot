...
def upload_posts(due_start_date: str, due_end_date: str):
    ...
    articles = [[a['author_id'], a['title'], a['slug'], a['date'], current_time] for a in articles]
...
if __name__ == '__main__':
    ...
    upload_posts('2023-03-20', '2023-04-06')
